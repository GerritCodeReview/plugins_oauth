...
This where previously named Office365 but both `plugin.gerrit-oauth-provider-azure-oauth` and 
...
```
This will try to link the old `office365-oauth` to the `azure-oauth` automatically.