...
public class CognitoOAuthService extends StandardResourceOAuthService {
  ...
  CognitoOAuthService(OAuthPluginConfigFactory cfgFactory, OAuth20ServiceFactory clientFactory) {
    super(cfgFactory.create(PROVIDER_NAME).getString(InitOAuth.SERVICE_NAME, "Cognito"));
    ...
    client =
        clientFactory.createClient(PROVIDER_NAME, new CognitoApi(rootUrl), "openid profile email");
