...
public class DexOAuthService implements OAuthServiceProvider {
  private static final Logger log = getLogger(DexOAuthService.class);
  ...
  public OAuthUserInfo getUserInfo(OAuthToken token) throws IOException  {
    ...
    JsonElement claimJson = JSON.newGson().fromJson(
            parseJwt(id_token.getAsString()), JsonElement.class);
