...
/**
 * Base for OpenID Connect providers that read the user information from the {@code id_token} carried
 * in the token response, rather than from a separately fetched resource.
 *
