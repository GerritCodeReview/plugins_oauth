...
class ScribeOAuthClient implements OAuthClient {
  ...
  /**
   * @param tolerateMissingTokenType when {@code true}, a missing {@code token_type} is stored as the
   *     empty string instead of failing. Providers such as CAS may omit it; the default keeps the
   *     value ScribeJava returns.
   */
