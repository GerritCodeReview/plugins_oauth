...
public class SAPOAuthServiceTest {
  ...
  @Mock private OAuth20ServiceFactory mockOAuth20ServiceFactory;
  ...
  public void setUp() throws Exception {
    when(mockOAuth20ServiceFactory.create(any(), any(), any())).thenReturn(mockScribeOAuthService);
  ...
  private SAPIasOAuthService createServiceAndInjectMock(boolean linkExistingGerritAccounts)
    ...
    SAPIasOAuthService serviceInstance =
        new SAPIasOAuthService(mockConfigFactory, mockOAuth20ServiceFactory, mockTokenValidator);
