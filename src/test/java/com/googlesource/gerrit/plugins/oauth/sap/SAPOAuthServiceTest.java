...
public class SAPOAuthServiceTest {
  ...
  private void mockSapIdTokenValidation(
      boolean valid, String userId, String email, String firstName, String lastName) {
  ...
  public void getUserInfo_linkExistingAccounts_shouldSetClaimedIdentity() throws Exception {
    ...
    mockSapIdTokenValidation(true, SAP_USER_ID, SAP_EMAIL, SAP_FIRST_NAME, SAP_LAST_NAME);
  ...
  public void fail_authentication() throws Exception {
    ...
    mockSapIdTokenValidation(false, SAP_USER_ID, SAP_EMAIL, SAP_FIRST_NAME, SAP_LAST_NAME);
