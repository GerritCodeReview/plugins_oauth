...
public class AirVantageOAuthServiceTest {
  ...
  public void constructor_buildsAirVantageDescriptor() {
    ...
    assertThat(ep.authorizationEndpoint())
        .isEqualTo("https://eu.airvantage.net/api/oauth/authorize");
    assertThat(ep.tokenEndpoint()).isEqualTo("https://eu.airvantage.net/api/oauth/token");
  ...
  private OAuthProviderEndpoints capturedEndpoints() {
    ...
    verify(mockClientFactory).create(eq(AirVantageOAuthService.PROVIDER_NAME), captor.capture());
