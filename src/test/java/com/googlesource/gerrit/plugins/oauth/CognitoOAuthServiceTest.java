...
public class CognitoOAuthServiceTest {
  ...
  public void getUserInfo_linkTrue_validUsername_shouldSetClaimedIdentity() throws Exception {
    ...
    // --- PRINTING OUTPUT ---
    System.out.println(
        "\n--- Test: getUserInfo_linkTrue_validUsername_shouldSetClaimedIdentity ---");
    System.out.println("Input - linkExistingGerrit: true");
    System.out.println("Input - Cognito Username (from mock): " + COGNITO_USERNAME);
    if (userInfo != null) {
      System.out.println("Output - OAuthUserInfo External ID: " + userInfo.getExternalId());
      System.out.println(
          "Output - OAuthUserInfo Username (getUserName()): " + userInfo.getUserName());
      System.out.println(
          "Output - OAuthUserInfo Claimed Identity: " + userInfo.getClaimedIdentity());
    } else {
      System.out.println("Output - OAuthUserInfo: null");
    }
    System.out.println(
        "--------------------------------------------------------------------------");
  ...
  public void getUserInfo_linkFalse_validUsername_shouldSetClaimedIdentityNull() throws Exception {
    ...
    // --- PRINTING OUTPUT ---
    System.out.println(
        "\n--- Test: getUserInfo_linkFalse_validUsername_shouldSetClaimedIdentityNull ---");
    System.out.println("Input - linkExistingGerrit: false");
    System.out.println("Input - Cognito Username (from mock): " + COGNITO_USERNAME);
    if (userInfo != null) {
      System.out.println("Output - OAuthUserInfo External ID: " + userInfo.getExternalId());
      System.out.println(
